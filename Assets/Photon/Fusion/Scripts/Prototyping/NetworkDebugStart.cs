...
public class NetworkDebugStart : Fusion.Behaviour {
  ...
  /// will be started as a dedicated server, or as a host (which is a server with a local playerRef).
  /// </summary>
  [InlineHelp]
  ...
  /// <summary>
  /// Start a single playerRef instance.
  /// </summary>
  ...
  /// <summary>
  /// Start a host instance. This is a server instance, with a local playerRef.
  /// </summary>
  ...
  /// <summary>
  /// Start a Fusion host instance (server with local playerRef), and the indicated number of additional client instances. 
  /// InstanceMode must be set to Multi-Peer mode, as this requires multiple <see cref="NetworkRunner"/> instances.
  /// </summary>
