...
public class PlayerAOIPrototype : NetworkBehaviour {
  ...
  /// The InputAuthority playerRef of this <see cref="NetworkObject"/>, 
  ...
  public override void FixedUpdateNetwork() {
    ...
    if (Runner.Topology == SimulationConfig.Topologies.ClientServer) {
      // Assign this object as an AOI region for the playerRef with input authority.
      ...
      // Assign this object as an AOI region for its State Authority playerRef
